...
<p align="center">
  ...
  ✏️ SSAFY (Samsung Software AI academy For youth) 12기 파이썬반 수료<br>
...
- [LangGraph](https://github.com/wwwoong1/LangGraph)

---
## 🗂 주요 프로젝트

### 1. CellCheck (배터리 셀 종류 및 불량 검사 AI)  
...
### 2. Yogayo (실시간 피드백을 위한 멀티모달(Image+Keypoint) Pose Estimation 시스템 개발)  
...
### 3. SSACLE (동공 추적, 표정 감지 면접 피드백 AI)  
